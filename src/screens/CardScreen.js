...
export default function CardScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: THEME.bg }}>
      <ScrollView
        style={{ flex: 1 }}
        contentContainerStyle={{ padding: 24, paddingTop: 18, paddingBottom: 24, flexGrow: 1 }}
      ...
      >
        ...
        >
          ...
          <View style={{ marginTop: 18 }}>
            ...
            {/* Optional refresh button so you can “re-verify” on demand */}
            <Pressable
              onPress={refreshVerified}
              style={{
                marginTop: 14,
                borderWidth: 1,
                borderColor: THEME.border,
            ...
            >
              <Text style={{ fontWeight: "800", color: THEME.dark }}>Refresh Verification</Text>
            </Pressable>
          </View>
        </View>
